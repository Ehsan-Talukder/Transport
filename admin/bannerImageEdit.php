...
$sql = "SELECT * FROM bannerimage where id=$id";
        ...
        <div class="row">
            ...
            <div class="col-12 col-md-12 col-lg-12">
                ...
                <div class="card">
                    ...
                    <!-- ############################## Form ############################## -->
                    <form action="bannerImageUpdate.php?id=<?php echo $id?>" method="post" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                <label class="col-sm-3 col-form-label"><strong>Assign For</strong></label>
                                <div class="col-sm-9">
                                    <select class="form-control selectric" name="assignFor">
                                        <option><?php echo $assiognFor?></option>
                                        <option>Home</option>
                                        <option>About</option>
